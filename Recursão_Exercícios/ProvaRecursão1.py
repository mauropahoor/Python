"""
1a Questão: Faça um programa, utilizando recursão, que leia um vetor de 1000 números inteiros e em seguida informe a quantidade de cada número que foi digitado nesse vetor. 
